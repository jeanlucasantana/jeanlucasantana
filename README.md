...
### Desenvolvedor .NET &nbsp;|&nbsp; C# · ASP.NET Core · SQL Server · Oracle

Ciência da Computação — UFOP (7º período) · Itabirito/MG
...
**Hoje estudo:** ASP.NET Core, Entity Framework Core, testes com xUnit e arquitetura em camadas.
...
`C#` `.NET` `ASP.NET Core` `Serenity Platform` `Node.js`

**Dados**

`SQL Server` `Oracle` `T-SQL` `PL/SQL` `Power BI` `DAX`

**Outros**

`TypeScript` `JavaScript` `Python` `C` `Git` `GitHub Actions`

---

### Contato

[LinkedIn](https://www.linkedin.com/in/jeanlucas-santana/) · jeanlucasfs2013@gmail.com
